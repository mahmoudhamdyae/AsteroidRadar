...
class AsteroidAdapter(private val clickListener: (asteroid: Asteroid) -> Unit) :
    ...
    private lateinit var binding: AsteroidViewItemBinding
    ...
    override fun onCreateViewHolder(
        ...
        binding =
            AsteroidViewItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class ViewHolder(private val binding: AsteroidViewItemBinding) :
        RecyclerView.ViewHolder(binding.root) {
